...
public class MyConnectUnit {
    //biến kết nối cơ bản
    private SQLSeverConnection connect;

    // hàm khởi tạo kết nối mặc định
    public MyConnectUnit() {
        connect = new SQLSeverConnection("LAPTOP-POOHLKIL\\SQLEXPRESS","WEB_DA2");
    }
    
    // hàm khởi tạo cơ bản
    public MyConnectUnit(String Host, String Database) {
        connect = new SQLSeverConnection(Host, Database);
    }
    ...
    public boolean InsertUTF8SanPham(String TableName, HashMap<String, Object> ColumnValues) throws Exception {
        // Khai báo biến StringBuilder để tạo chuỗi Select
        StringBuilder query = new StringBuilder("Insert Into " + TableName);
        // khai báo biến StringBuilder để tạo chuỗi Column Values
        StringBuilder valueInsert = new StringBuilder();
        ...
        for (String key : ColumnValues.keySet()) {
            query.append(key + ",");
            if(key.equals("MotaSP") || key.equals("TenSP") || key.equals("AnhSP")) {
    ...
    public boolean InsertUTF8DonDatHang(String TableName, HashMap<String, Object> ColumnValues) throws Exception {
        // Khai báo biến StringBuilder để tạo chuỗi Select
        StringBuilder query = new StringBuilder("Insert Into " + TableName);
        // khai báo biến StringBuilder để tạo chuỗi Column Values
        StringBuilder valueInsert = new StringBuilder();
        ...
        for (String key : ColumnValues.keySet()) {
            query.append(key + ",");
            if(key.equals("DiaChiKH") || key.equals("TenKH")) {
            	valueInsert.append("N'" + ColumnValues.get(key).toString() + "',");
            }else {
            	valueInsert.append("'" + ColumnValues.get(key).toString() + "',");
            }
    ...
    public boolean InsertUTF8TinTuc(String TableName, HashMap<String, Object> ColumnValues) throws Exception {
        // Khai báo biến StringBuilder để tạo chuỗi Select
        StringBuilder query = new StringBuilder("Insert Into " + TableName);
        // khai báo biến StringBuilder để tạo chuỗi Column Values
        StringBuilder valueInsert = new StringBuilder();
        ...
        for (String key : ColumnValues.keySet()) {
            query.append(key + ",");
            if(key.equals("TieuDe") || key.equals("MoTa") || key.equals("ChiTiet") || key.equals("AnhDaiDien")) {
            	valueInsert.append("N'" + ColumnValues.get(key).toString() + "',");
            }else {
            	valueInsert.append("'" + ColumnValues.get(key).toString() + "',");
            }
    ...
    public boolean InsertUTF8KhachHang(String TableName, HashMap<String, Object> ColumnValues) throws Exception {
        // Khai báo biến StringBuilder để tạo chuỗi Select
        StringBuilder query = new StringBuilder("Insert Into " + TableName);
        // khai báo biến StringBuilder để tạo chuỗi Column Values
        StringBuilder valueInsert = new StringBuilder();
    ...
    public boolean UpdateUTF8KhachHang(String TableName, HashMap<String, Object> ColumnValues, String Condition) throws Exception {
        // khai báo biến StringBuilder để tạo chuỗi CSDL
        StringBuilder query = new StringBuilder("Update " + TableName + " Set ");
        
        // Duyệt và đưa thông tin tên cột, giá trị
        for (String key : ColumnValues.keySet()) {
        	if(key.equals("TenKh") || key.equals("AnhDaiDien") || key.equals("DiaChiKH")) {
    ...
    public boolean UpdateUTF8SanPham(String TableName, HashMap<String, Object> ColumnValues, String Condition) throws Exception {
        // khai báo biến StringBuilder để tạo chuỗi CSDL
        StringBuilder query = new StringBuilder("Update " + TableName + " Set ");
    ...
    public boolean UpdateUTF8DonDatHang(String TableName, HashMap<String, Object> ColumnValues, String Condition) throws Exception {
        // khai báo biến StringBuilder để tạo chuỗi CSDL
        StringBuilder query = new StringBuilder("Update " + TableName + " Set ");
        
        // Duyệt và đưa thông tin tên cột, giá trị
        for (String key : ColumnValues.keySet()) {
        	if(key.equals("TenKH") || key.equals("DiaChiKH")) {
        		query.append(key + " = N'" + ColumnValues.get(key).toString() + "',");
        	}else {
        		query.append(key + " = '" + ColumnValues.get(key).toString() + "',");
        	}
