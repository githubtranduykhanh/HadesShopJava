        ...
        <div class="row">
            <div class="col-md-8 col-lg-9 p-b-80">
                <div class="p-r-45 p-r-0-lg">
                	<c:forEach items="${LISTBLOGITEM}"  var="item">
						<!-- item blog -->
                    <div class="p-b-63">
                        <a href="BlogDetail?ID=${item.tinTucID}" class="hov-img0 how-pos5-parent">
                            <img src="assets/images/ItemTinTuc/${item.anhDaiDien}" alt="IMG-BLOG">
                        ...
                        <div class="p-t-32">
                            <h4 class="p-b-15">
                                <a href="BlogDetail?ID=${item.tinTucID}" class="ltext-108 cl2 hov-cl1 trans-04">
                                    ${item.tieuDe}
                                </a>
                            </h4>
                            ...
                            <div class="flex-w flex-sb-m p-t-18">
                                <span class="flex-w flex-m stext-111 cl2 p-r-30 m-tb-10">
                                    ...
                                    <span>
                                        ${item.luotXem} Comments
                                    </span>
                                </span>

                                <a href="BlogDetail?ID=${item.tinTucID}" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
                                    Continue Reading
            ...
            <div class="col-md-4 col-lg-3 p-b-80">
                <div class="side-menu">
                    ...
                    <div class="p-t-50">
                        ...
                        <div class="flex-w m-r--5" id="js-tag-caterory-blog">
